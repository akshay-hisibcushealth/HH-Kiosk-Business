...
/// A Boolean value that determines whether the camera’s video should be mirrored, only applies to the external camera — Default is <code>true</code>
@property (nonatomic) BOOL isExternalCameraVideoMirrored;
/// A Boolean value that determines whether to use only the external camera. If false, the external camera and the built-in camera are automatically switched, the external camera has a higher priority — Default is <code>false</code>
@property (nonatomic) BOOL isUseExternalCameraOnly;
