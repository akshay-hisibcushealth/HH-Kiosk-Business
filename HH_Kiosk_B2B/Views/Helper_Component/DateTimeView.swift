...
struct DateTimeView: View {
    ...
    var timeString: String {
        AppLocalization.dateFormatter(format: "h:mm a").string(from: currentDate)
    }

    var dayName: String {
        AppLocalization.dateFormatter(format: "EEEE").string(from: currentDate)
    }

    var dateString: String {
        AppLocalization.dateFormatter(format: "MMM d").string(from: currentDate)
    }
